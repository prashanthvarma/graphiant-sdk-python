...
v1_gateways_guest_consumer_get200_response_instance = V1GatewaysGuestConsumerGet200Response.from_json(json)
# print the JSON string representation of the object
print(V1GatewaysGuestConsumerGet200Response.to_json())

# convert the object into a dict
v1_gateways_guest_consumer_get200_response_dict = v1_gateways_guest_consumer_get200_response_instance.to_dict()
# create an instance of V1GatewaysGuestConsumerGet200Response from a dict
v1_gateways_guest_consumer_get200_response_from_dict = V1GatewaysGuestConsumerGet200Response.from_dict(v1_gateways_guest_consumer_get200_response_dict)
```
