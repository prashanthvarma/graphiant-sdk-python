...
v2_extranet_service_overtime_consumption_post_request_instance = V2ExtranetServiceOvertimeConsumptionPostRequest.from_json(json)
# print the JSON string representation of the object
print(V2ExtranetServiceOvertimeConsumptionPostRequest.to_json())

# convert the object into a dict
v2_extranet_service_overtime_consumption_post_request_dict = v2_extranet_service_overtime_consumption_post_request_instance.to_dict()
# create an instance of V2ExtranetServiceOvertimeConsumptionPostRequest from a dict
v2_extranet_service_overtime_consumption_post_request_from_dict = V2ExtranetServiceOvertimeConsumptionPostRequest.from_dict(v2_extranet_service_overtime_consumption_post_request_dict)
```
